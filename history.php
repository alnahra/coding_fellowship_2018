...
<body>
	...
	<br><br><br>
		...
		<br><br>
			But it's really difficult to substantiate these claims, because each municipality stores their information differently.
			It's difficult to compare the spending in one area to another, because the same pot of money could be titled differently between them.
			And matching that spending to revenue from traffic stops and ticket violations is laborious and time-consuming without a standardized database to pull from.
		<br><br>
