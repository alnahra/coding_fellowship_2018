...
<html>
	...
	<body>
		...
		<div class='post2'>
			...
			policing in St. Louis County is extraordinarily difficult to understand.
		<br><br>
			The number of municipalities in a relatively condensed area may seem striking. It should. For example—Champ, Missouri, is a municipality of 11 people.
			And the number of incorporated municipalities does not even cover the unincorporated areas of the St. Louis region, of which there are several pockets
			that simply exist without formal governmental structures. Many of the existing municipalities employ their own police forces, which cover areas ranging from 0.11 square
		...
		<br><br><br>
			<div class='post2'>
				...
				as fact that these municipalities exist distinct from each other. There is no reason for the area's fragmentation aside from this history of racism.
				Allowing such small areas function as their own governments means that the tax bases for each area are limited in scope, and many of the public services remaining do not make enough moeny to continue to function.
				These underfunded departments rely on tickets and other incedental sources of revenue to bankroll police forces, firefighters, and myriad other services. Even when they're unnecessary.
			<br><br>
				But it's really difficult to substantiate any derogatory claims, because each municipality stores their information differently. And comply to varying degrees with requests (or orders) to provide information.
